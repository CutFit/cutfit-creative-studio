...
import { hero_data } from "@/modelDataset";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center w-full h-full">
        ...
        >
          <motion.h1
            className="text-[#FFFFFF] text-4xl md:text-6xl font-extrabold tracking-tight mb-6"
          ...
          <motion.p
            className="text-[#E5E5E5] mb-8 text-center w-[100%] md:w-[90%] text-lg font-semibold"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.6, duration: 1 }}
          >
            {hero_data?.sub_heading ?? ""}
          </motion.p>
          ...
          >
            <Button
              className="bg-[#D7263D] text-black hover:text-black hover:bg-[#E5E5E5] text-lg px-4 py-5 transform transition duration-300 hover:scale-95 border border-black font-semibold"
              onClick={() => navigate("/packages-billing?mode=easy_pack")}
            >
              {hero_data?.btn_cta ?? ""}
            </Button>
