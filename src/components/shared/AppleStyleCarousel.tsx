    ...
    <>
      ...
      >
        ...
        <div className="relative z-40 p-5 md:p-8">
          ...
          <Button
            className="bg-[#D7263D] hover:bg-[#D7263D] text-black text-sm px-2 md:px-4 py-2 md:py-4 transform transition duration-300 hover:scale-90 mt-2 md:mt-4"
            onClick={() =>
              navigate(
                identifier === "academy"
        ...
        <BlurImage
          src={card.src ?? "https://res.cloudinary.com/ddwaoyedq/image/upload/v1764758281/ccsp4sds01_wbn8to.png"}
          alt={card.title}
