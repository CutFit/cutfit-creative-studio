    ...
    <section className="relative bg-black text-white py-32 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto px-6">
        <h2 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
          {featuredblocks[2]?.title}
        </h2>

        <p className="text-lg text-[#E5E5E5]/80 mb-10 max-w-2xl mx-auto">
          {featuredblocks[2]?.text}
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button
            className="bg-[#D7263D] text-black px-4 py-6 text-base hover:bg-[#D7263D] hover:scale-105 transition-transform duration-300"
