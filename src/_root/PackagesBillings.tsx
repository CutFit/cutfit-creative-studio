...
const PackagesBillings = () => {
  ...
  const config = {
    ...
    customizations: {
      title: `Payment for ${pkg?.name ?? "CutFit Creative Studio"} Order`,
      ...
      handleFlutterPayment({
        callback: async (response) => {
          if (response.status === "completed") {
            ...
            await axios.post(
              "https://hook.eu2.make.com/rs5giohqw",
              payload
            );
            ...
            if (promoCode !== "N/A") {
              ...
              await axios.post(
                "https://hook.eu2.make.com/m8vvjgh",
                affiliatePayload
              );
            }
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <h2 className="text-4xl font-extrabold mb-3">
            Complete Your <span className="text-[#D7263D]">Order</span>
          </h2>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 h-fit sticky top-10">
          ...
          <div className="space-y-3 mb-6">
            ...
            <p className="text-4xl font-extrabold text-[#D7263D]">
          ...
          <ul className="space-y-2 text-white/70 text-sm">
            {pkg.features.map((f, i) => (
              <li key={i} className="flex items-start gap-2">
                <span className="text-[#D7263D] mt-1">•</span>
                {f}
              </li>
            ))}
          </ul>
